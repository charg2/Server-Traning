...
class PacketManager
{
    ...
    {
     _onRecv.Add( (ushort)PacketID.S_PlayerInfoResult, MakePacket<S_PlayerInfoResult> );
        _handler.Add( (ushort)PacketID.S_PlayerInfoResult, PacketHandler.S_PlayerInfoResultHandler );
